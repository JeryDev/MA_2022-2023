...
# Wichtig:
# Dieses Programm funktioniert nur auf Windows!
# Es lässt sich auch ganz normal über cmd starten.
# Ist der Code, welcher in der Windows App steckt.

# Packages:
# -> https://github.com/JeryDev/MA_2022-2023/blob/main/source/Windows/dependencies.txt
...
if platform.system() == "Windows":
  ...
  folder_path = os.path.join(desktop, "Maturaarbeit_Jery")
